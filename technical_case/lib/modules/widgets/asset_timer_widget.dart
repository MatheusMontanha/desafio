...
class AssetTimerWidget extends StatefulWidget {
  final double maxHeight;
  final AssetChosen assetChosen;
  final Alignment alignment;
  const AssetTimerWidget({
    Key? key,
  ...
  @override
  State<AssetTimerWidget> createState() => _AssetWidgetState();
}

class _AssetWidgetState extends State<AssetTimerWidget> {
  int second = 2;
  late Timer timer;
